                        ...
                        a(".drag-target")
                            ...
                            .bind("pan", function (d) {
                                if ("touch" == d.gesture.pointerType) {
                                    ...
                                    "left" === b.edge
                                        ? ((overlayPerc = f / b.menuWidth), a("#sidenav-overlay").velocity({ opacity: overlayPerc }, { duration: 50, queue: !1, easing: "easeOutQuad" }))
                                        : ((overlayPerc = Math.abs((f - a(window).width()) / b.menuWidth)), a("#sidenav-overlay").velocity({ opacity: overlayPerc }, { duration: 50, queue: !1, easing: "easeOutQuad" }));
                                }
                            })
    ...
    (function (a, b, c, d) {
        ...
        (e.prototype.init = function () {
                ...
                if (!g.isTouch() || "mousedown" !== d.type) {
                    ...
                    if (f || h) {
                        var i = g.getRipplesColor(c),
                            j = a("<div></div>");
                        j.addClass("ripple").css({ left: h, top: f, "background-color": i }),
                            e.append(j),
                            (function () {
                            ...
                            c.on("mouseup mouseleave touchend", function () {
            ...
            (e.prototype.rippleOn = function (a, b) {
                ...
                g.hasTransitionSupport()
                    ? b
                          .css({ "-ms-transform": "scale(" + c + ")", "-moz-transform": "scale(" + c + ")", "-webkit-transform": "scale(" + c + ")", transform: "scale(" + c + ")" })
                          .addClass("ripple-on")
                          .data("animating", "on")
                          .data("mousedown", "on")
                    : b.animate(
...
var theme_colors = { "brand-primary": "blue", "brand-success": "green", "brand-info": "purple", "brand-warning": "orange", "brand-danger": "red", theme: "pink", "theme-secondary": "blue" },
    global_colors = {
        ...
        shades: { black: "#000000", white: "#FFFFFF" },
    };
$(function () {
    $('[data-toggle="tooltip"]').tooltip(), $('[data-toggle="popover"]').popover(), $(".navbar-toggle").sideNav({ menuWidth: 260, closeOnClick: !0 });
    ...
    $("body").find(a).ripples(),
        $(".form-control").each(function () {
            $(this).val() && $(this).parent().addClass("filled"),
                $(this)
...
$(function () {
    if ($(".charts").length > 0) {
        (colors = ["#4CAF50", "#2196F3", "#9c27b0", "#ff9800", "#F44336"]),
            (guage_options = { data: { columns: [["data", 50]], type: "gauge" }, transition: { duration: 500 }, color: { pattern: colors, threshold: { values: [20, 50, 70, 100, 110] } } });
        ...
        interval = setInterval(function () {
            d.load({ columns: [["data", Math.floor(100 * Math.random() + 1)]] }), e.load({ columns: [["data", Math.floor(100 * Math.random() + 1)]] }), f.load({ columns: [["data", Math.floor(100 * Math.random() + 1)]] });
        }, 2e3);
        c3.generate({
            bindto: "#line-chart",
            data: {
    ...
    $(function () {
        (people = [
            ...
            $(".select2").select2({ data: people, minimumResultsForSearch: 1 / 0, placeholder: "Select based on select2", templateSelection: templateSelection, templateResult: templateResult }),
            $(".select2-tags").select2({ data: colors, tags: !0, placeholder: "Choose a color" }),
            $(".datepicker").datetimepicker({ format: "MM/DD/YYYY" }),
            $(".timepicker").datetimepicker({ format: "HH:mm" }),
            $(".datepicker-from").datetimepicker({ format: "MM/DD/YYYY" }),
            $(".datepicker-until").datetimepicker({ format: "MM/DD/YYYY" }),
            ...
            $(".typeahead").typeahead({ source: states, autoSelect: !0 }),
            ...
            $(".wysiwyg").summernote(),
            $(".slider-1").noUiSlider({ start: 6, step: 0, range: { min: [0], max: [21] } }),
            $(".slider-2").noUiSlider({ start: [6, 25], step: 1, range: { min: [0], max: [100] } }),
            ...
            $(".slider-3").noUiSlider({ start: [16], step: 2, range: { min: [0], max: [20] } }),
            $(".slider-3").on("slide set change", function (a, b) {
                $(this).find(".noUi-handle div").length ||
                    $(this)
                        .find(".noUi-handle")
                        .append("<div>" + b + "</div>"),
...
(randomData = function (a, b, c) {
    for (data = [], i = 0; i < a; ++i)
        data.length
            ? ((factor = 3), (minOrganic = data[data.length - 1] - factor), (maxOrganic = data[data.length - 1] + factor), data.push(random_load_value(minOrganic < b ? b : minOrganic, maxOrganic > c ? c : maxOrganic)))
            : data.push(random_load_value(b, c));
    return data;
}),
    (chartDat = randomData(10, 40, 60)),
    (chartData1 = randomData(10, 40, 60)),
    (chartData2 = randomData(20, 40, 60)),
    (chartData3 = randomData(20, 40, 60)),
    (chartData4 = randomData(100, 10, 30)),
    chartDat.unshift("Inscriptions"),
    ...
    (serverLoadOptions = {
        ...
        legend: { show: !1 },
        padding: { top: 6, right: -1, bottom: -8, left: 0 },
        data: { columns: [["Server load"].concat(values)], type: "area" },
        size: { height: 160 },
        axis: { x: { show: !1, padding: { left: 0, right: 0 } }, y: { show: !1, max: 100, min: 0, padding: { top: 0, bottom: 0 } } },
        grid: { focus: { show: !1 } },
        point: { show: !1 },
        tooltip: {
            format: {
...
var chartLine1 = { bindto: "#chart-line-1", data: { columns: [chartDat] }, axis: { x: { show: !1 }, y: { show: !1 } }, color: { pattern: ["#fff"] }, legend: { hide: !0 }, size: { height: 100 } },
    ...
    chartArea1 = {
        bindto: "#chart-area-1",
        data: { columns: [chartData4], types: { Customers: "area" } },
        axis: { x: { show: !1 }, y: { show: !1 } },
        color: { pattern: ["#EC407A"] },
        legend: { hide: !0 },
        size: { height: 100 },
        padding: { right: -18, bottom: -28, left: -18 },
    },
    chartGauge1 = { bindto: "#chart-gauge-1", data: { columns: [["data", 80]], types: { data: "gauge" } }, gauge: { width: 3 }, color: { pattern: ["#E91E63"] }, legend: { hide: !0 }, tooltip: { show: !1 }, size: { height: 80 } },
    chartGauge2 = { bindto: "#chart-gauge-2", data: { columns: [["data", 30]], types: { data: "gauge" } }, gauge: { width: 3 }, color: { pattern: ["#E91E63"] }, legend: { hide: !0 }, tooltip: { show: !1 }, size: { height: 80 } },
    chartGauge3 = { bindto: "#chart-gauge-3", data: { columns: [["data", 40]], types: { data: "gauge" } }, gauge: { width: 3 }, color: { pattern: ["#E91E63"] }, legend: { hide: !0 }, tooltip: { show: !1 }, size: { height: 80 } },
    colors = ["#4CAF50", "#2196F3", "#9c27b0", "#ff9800", "#F44336"],
    chartPageviews = {
        bindto: "#chart-pagesviews",
        data: { columns: [["Pageviews", 3, 4, 5, 10, 20, 14, 18, 12, 10, 20, 10, 14, 15, 10, 20, 14, 18, 12, 10, 20]], types: { Pageviews: "area" } },
        axis: { x: { show: !1 }, y: { show: !1 } },
        color: { pattern: ["#fff"] },
        legend: { hide: !0 },
        size: { height: 100 },
...
$(".dashboard").length > 0 &&
        ...
        axis: {
          x: {
            ...
            tick: {
                ...
                values: [ "2016-09-01", "2016-09-02", "2016-09-03", "2016-09-04", "2016-09-05", "2016-09-06"]
              }
            }
        },
        color: { pattern: colors },
    ...
    $(function () {
        if (($("#full-map-canvas").length > 0 && new GMaps({ div: "#full-map", lat: 45, lng: -73, zoom: 8, width: "100%", height: "100%" }), $(".maps-widgets").length > 0)) {
            new GMaps({ div: "#map-basic", lat: 45, lng: -73, zoom: 8, height: "350px" });
            ...
            $("#slider").on({
                ...
                (min = $("#slider").data("min")),
                (max = $("#slider").data("max")),
                $("#slider").noUiSlider({ start: start, step: 0, range: { min: [min], max: [max] } });
            ...
            var c = new GMaps({ div: "#map-clickable", lat: 45, lng: -73, zoom: 2, height: "350px" }),
                d = [];
            d.push({ id: 0, lat: 52.369371, lng: 4.894494, title: "Amsterdam" }),
                d.push({ id: 1, lat: 40.712942, lng: -74.005774, title: "New York" }),
                d.push({ id: 2, lat: 41.385196, lng: 2.173315, title: "Barcelona" }),
                d.push({ id: 3, lat: 37.764355, lng: -122.451954, title: "San Francisco" }),
                c.addMarkers(d),
        ...
        $(".map-canvas").vectorMap({
            ...
            hoverOpacity: 0.7,
            hoverColor: !1,
            series: { regions: [{ scale: [theme("darken-2"), theme("lighten-2")], attribute: "fill" }] },
            regionStyle: { initial: { fill: theme() } },
            markerStyle: { initial: { stroke: theme_secondary("lighten-1"), fill: theme_secondary("darken-1") }, hover: { stroke: theme_secondary("lighten-3") } },
    ...
    (function (a, b, c) {
        var d = function (a, c) {
            "use strict";
            a.extend(!0, c.defaults, { dom: "<'row'<'col-sm-6'l><'col-sm-6'f>><'row'<'col-sm-12'tr>><'row'<'col-sm-5'i><'col-sm-7'p>>", renderer: "bootstrap" }),
                a.extend(c.ext.classes, { sWrapper: "dataTables_wrapper form-inline dt-bootstrap", sFilterInput: "form-control input-sm", sLengthSelect: "form-control input-sm" }),
                        ...
                        q = function (b, c) {
                            ...
                            for (e = 0, g = c.length; g > e; e++)
                                if (((r = c[e]), a.isArray(r))) q(b, r);
                                    ...
                                    j &&
                                        ((l = a("<li>", { class: n.sPageButton + " " + k, id: 0 === f && "string" == typeof r ? d.sTableId + "_" + r : null })
                                            .append(a("<a>", { href: "#", "aria-controls": d.sTableId, "data-dt-idx": p, tabindex: d.iTabIndex }).html(j))
                                            .appendTo(b)),
                                        d.oApi._fnBindAction(l, { action: r }, s),
                                        p++);
                                }
                        };
                    try {
                ...
                c.TableTools &&
                    (a.extend(!0, c.TableTools.classes, {
                    ...
                    a.extend(!0, c.TableTools.DEFAULTS.oTags, { collection: { container: "ul", button: "li", liner: "a" } }));
        };
