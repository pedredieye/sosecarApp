(function($) {
	...
	if($('.time-countdown').length){  
		...
		$this.countdown(finalDate, function(event) {
			var $this = $(this).html(event.strftime('' + '<div class="counter-column"><span class="count">%D</span>Jours</div> ' + '<div class="counter-column"><span class="count">%H</span>Heures</div>  ' + '<div class="counter-column"><span class="count">%M</span>Minutes</div>  ' + '<div class="counter-column"><span class="count">%S</span>Secondes</div>'));
		});
	 });
	}
	...
	if($('.cs-countdown').length){
	   ...
	   $('.cs-countdown').countdown('').on('update.countdown', function(event) {
		  var $this = $(this).html(event.strftime('<div><span>%m</span><h6>Mois</h6></div> <div><span>%D</span><h6>jours</h6></div> <div><span>%H</span><h6>Heures</h6></div> <div><span>%M</span><h6>Minutes</h6></div> <div><span>%S</span><h6>Secondes</h6></div>'));
		});
	}
